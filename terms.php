...
<body>
	...
	<header>
		...
		<div class="container">
			<a class="logo" href="index.php"><p class="logo-text color-primary" alt="Logo">Health blog</p></a>
...
<section class="ptb-0">
		...
		<div class="container">
			<a class="mt-10" href="index.php"><i class="mr-5 ion-ios-home"></i>Main<i class="mlr-10 ion-chevron-right"></i></a>
			<a class="color-ash mt-10" href="terms.php">Terms and conditions</a>
		</div><!-- container -->
	</section>
